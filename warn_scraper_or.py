...
#     # page range needs to be updated to 45 when there are enough notices for an additional page
#     # as of 5/4/2020, this version of the scraper is fine
...
#         url = 'https://ccwd.hecc.oregon.gov/Layoff/WARN?page={}'.format(page_number)
